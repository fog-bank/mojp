...
namespace Mojp
{
    ...
    public partial class App : Application
    {
        ...
        /// </summary>
        public static Dictionary<string, Card> Cards { get; } = new Dictionary<string, Card>(21336);
        ...
        /// 代替テキストによるカード検索を行います。
        /// </summary>
        public static Dictionary<string, AltCard> AltCards { get; } = new Dictionary<string, AltCard>(343);
